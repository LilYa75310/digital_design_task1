# 1 "C:\\Users\\lilya\\Documents\\vitis_projects\\Super_Ultra_Processor\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Users\\lilya\\Documents\\vitis_projects\\Super_Ultra_Processor\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\Users\\lilya\\Documents\\vitis_projects\\Super_Ultra_Processor\\hw\\sdt\\pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  axi_gpio_op_sel: gpio@40000000 {
   ...
   xlnx,name = "axi_gpio_op_sel";
   xlnx,all-inputs = <0>;
  };
  axi_gpio_reg_data: gpio@40010000 {
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   xlnx,all-outputs = <1>;
   #gpio-cells = <2>;
   ...
   clock-names = "s_axi_aclk";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_reg_data";
   xlnx,all-inputs = <0>;
  };
  mdm_1: serial@41400000 {
...
# 3 "C:\\Users\\lilya\\Documents\\vitis_projects\\Super_Ultra_Processor\\hw\\sdt\\system-top.dts" 2
/ {
 device_id = "7a35t";
 #address-cells = <1>;
 #size-cells = <1>;
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0x00000000 &microblaze_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x4000>,
         ...
         <0x40000000 &axi_gpio_op_sel 0x40000000 0x10000>,
         <0x40010000 &axi_gpio_reg_data 0x40010000 0x10000>,
