...
# pwm to leds (GPIO)
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33} [get_ports pwm_o]
...
# кнопки op_sw (GPIO)
set_property -dict {PACKAGE_PIN H20 IOSTANDARD LVCMOS33 PULLUP TRUE} [get_ports op_sw]
